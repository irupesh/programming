...
public class TrafficStats {
    ...
    public static long getMobileTxBytes() {
        long total = 0;
        for (String iface : getMobileIfaces()) {
            /* 2014-10-03 chisung.in@lge.com LGP_DATA_TETHER_SUPPORT_IPV4_TETHER_WITH_CLAT_DATA_USAGE [START] */
            if ((iface.startsWith("v4-")) || (iface.equals("bridge0"))) {
                LGDataRuntimeFeature.patchCodeId("LPCP-707@n@c@boot-framework@TrafficStats.java@1");
                continue;
            }
            /* 2014-10-03 chisung.in@lge.com LGP_DATA_TETHER_SUPPORT_IPV4_TETHER_WITH_CLAT_DATA_USAGE [END] */
    ...
    public static long getMobileRxBytes() {
        ...
        for (String iface : getMobileIfaces()) {
            /* 2014-10-03 chisung.in@lge.com LGP_DATA_TETHER_SUPPORT_IPV4_TETHER_WITH_CLAT_DATA_USAGE [START] */
            if ((iface.startsWith("v4-")) || (iface.equals("bridge0"))) {
                LGDataRuntimeFeature.patchCodeId("LPCP-707@n@c@boot-framework@TrafficStats.java@2");
                continue;
            }
            /* 2014-10-03 chisung.in@lge.com LGP_DATA_TETHER_SUPPORT_IPV4_TETHER_WITH_CLAT_DATA_USAGE [END] */
    ...
    public static long getMobileTcpRxPackets() {
        ...
        for (String iface : getMobileIfaces()) {
            ...
            /* 2013-05-15 dongju.ko@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [START] */
            if (iface == null || iface.length() == 0) {
                LGDataRuntimeFeature.patchCodeId("LPCP-850@n@c@boot-framework@TrafficStats.java@1");
                continue;
            }
            /* 2013-05-15 dongju.ko@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [END] */
            try {
    ...
    public static long getMobileTcpTxPackets() {
        ...
        for (String iface : getMobileIfaces()) {
            ...
            /* 2013-05-15 dongju.ko@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [START] */
            if (iface == null || iface.length() == 0) {
                LGDataRuntimeFeature.patchCodeId("LPCP-850@n@c@boot-framework@TrafficStats.java@2");
                continue;
            }
            /* 2013-05-15 dongju.ko@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [END] */
            try {
    ...
    public static long getTxPackets(String iface) {
        /* 2013-05-15 dongju.ko@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [START] */
        if (iface == null || iface.length() == 0) {
            LGDataRuntimeFeature.patchCodeId("LPCP-850@n@c@boot-framework@TrafficStats.java@3");
            return 0;
        }
        /* 2013-05-15 dongju.ko@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [END] */
        try {
    ...
    public static long getRxPackets(String iface) {
        /* 2013-05-15 dongju.ko@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [START] */
        if (iface == null || iface.length() == 0) {
            LGDataRuntimeFeature.patchCodeId("LPCP-850@n@c@boot-framework@TrafficStats.java@4");
            return 0;
        }
        /* 2013-05-15 dongju.ko@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [END] */
        try {
    ...
    public static long getTxBytes(String iface) {
        /* 2013-05-15 dongju.ko@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [START] */
        if (iface == null || iface.length() == 0) {
            LGDataRuntimeFeature.patchCodeId("LPCP-850@n@c@boot-framework@TrafficStats.java@5");
            return 0;
        }
        /* 2013-05-15 dongju.ko@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [END] */
        try {
    ...
    public static long getRxBytes(String iface) {
        /* 2013-05-15 dongju.ko@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [START] */
        if (iface == null || iface.length() == 0) {
            LGDataRuntimeFeature.patchCodeId("LPCP-850@n@c@boot-framework@TrafficStats.java@6");
            return 0;
        }
        /* 2013-05-15 dongju.ko@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [END] */
        try {
    ...
    /** {@hide} */
    public static long getUidTxPacketsForAutoDDS(int uid) {
        final int callingUid = android.os.Process.myUid();
        if (callingUid == android.os.Process.PHONE_UID || callingUid == uid) {
            try {
                return getStatsService().getUidStats(uid, TYPE_TX_PACKETS);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
...
/** {@hide} */
    public static long getUidRxPacketsForAutoDDS(int uid) {
        final int callingUid = android.os.Process.myUid();
        if (callingUid == android.os.Process.PHONE_UID || callingUid == uid) {
            try {
                return getStatsService().getUidStats(uid, TYPE_RX_PACKETS);
    ...
    private static String[] getMobileIfaces() {
        try {
            ...
            /* 2014-11-13 kwangbin.yim@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [START] */
            LGDataRuntimeFeature.patchCodeId("LPCP-850@n@c@boot-framework@TrafficStats.java@9");
            //throw e.rethrowFromSystemServer(); original native
            /* 2014-11-13 kwangbin.yim@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [END] */
        }

        /* 2014-11-13 kwangbin.yim@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [START] */
        LGDataRuntimeFeature.patchCodeId("LPCP-850@n@c@boot-framework@TrafficStats.java@10");
        return new String[0];
        /* 2014-11-13 kwangbin.yim@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [END] */
    }
...
// [START][LGE_WIFI][COMMON][minsu.choi@lge.com] : [SPEC] Update Packet count using iface_stats_all for IPA Enabled model
//    private static native long nativeGetIfaceStatAll(String iface, int type);

    /** {@hide} */
    public static long getAllTxPackets(String iface) {
        long ret = 0;
        if (iface == null || iface.length() == 0) {
            return 0;
        }
        ...
        try {
           ret = getStatsService().getIfaceStatsAll(iface, TYPE_TX_PACKETS);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
        return ret;
    ...
    /** {@hide} */
    public static long getAllRxPackets(String iface) {
        long ret = 0;
        if (iface == null || iface.length() == 0) {
            return 0;
        }
        try {
           ret = getStatsService().getIfaceStatsAll(iface, TYPE_RX_PACKETS);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
        return ret;
    }
// [END][LGE_WIFI][COMMON][minsu.choi@lge.com] : [SPEC] Update Packet count using iface_stats_all for IPA Enabled model
    ...
    public static long getTcpTxPackets(String iface) {
        ...
        /* 2013-05-15 dongju.ko@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [START] */
        if (iface == null || iface.length() == 0) {
            LGDataRuntimeFeature.patchCodeId("LPCP-850@n@c@boot-framework@TrafficStats.java@7");
            return 0;
        }
        /* 2013-05-15 dongju.ko@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [END] */
    ...
    public static long getTcpRxPackets(String iface) {
        ...
        /* 2013-05-15 dongju.ko@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [START] */
        if (iface == null || iface.length() == 0) {
            LGDataRuntimeFeature.patchCodeId("LPCP-850@n@c@boot-framework@TrafficStats.java@8");
            return 0;
        }
        /* 2013-05-15 dongju.ko@lge.com LGP_DATA_TD_DEAD_OBJECT_EXCEPTION_IN_TRAFFIC_STATS [END] */
